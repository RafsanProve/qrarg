...
export default function ExpertisePage() {
  return (
    ...
    description={"Dr. Muhammad Towfiqur Rahman is an Assistant Professor in the Department of Computer Science and Engineering at the University of Asia Pacific (UAP), Dhaka, Bangladesh. He earned his Ph.D. in Electrical Engineering, focusing on Visible Light Communication, from Monash University, Australia.e also holds a Master of Science in Communication Engineering from the International Islamic University Malaysia and an MBA from the International Islamic University Chittagong, Bangladesh. Before joining UAP in August 2021, Dr. Rahman served as an Adjunct Faculty member in the Department of Electrical and Electronic Engineering at Northern University Bangladesh and as a Teaching Staff in Electrical Engineering at Monash University. His research interests include 5G-enabled Visible Light Communication Technology, Optical OFDM, and hybrid communication systems. Dr. Rahman has supervised numerous theses at both undergraduate and graduate levels, contributing significantly to advancements in optical and wireless communication technologies."}
    ...
    description={"Dr. Hosney Jahan is an Assistant Professor in the Department of Computer Science & Engineering at the Military Institute of Science and Technology (MIST), Dhaka, Bangladesh. She earned her Ph.D. in Computer Science and Technology from Sichuan University, China, and her M.Sc. in Computer Software and Theory from Nanjing University of Science and Technology, China. Her research interests include Software Engineering, Software Testing, Machine Learning, and Formal Methods. Dr. Jahan has published in various reputable journals and conferences, contributing to advancements in her field. She has also been involved in research projects focusing on software test case prioritization using artificial neural networks and drug-target interaction prediction using machine learning techniques. Prior to her current role, she gained experience as a Research and Teaching Assistant at Sichuan University and worked as a Software Quality Assurance Engineer in Bangladesh. Dr. Jahan has been recognized with several awards, including the Chinese Government Scholarship for her Ph.D. studies."}
    ...
    description={"Dr. S.M. Sadakatul Bari is an Assistant Professor and Chairman of the Department of Aircraft Maintenance Engineering (Avionics) at Bangabandhu Sheikh Mujibur Rahman Aviation and Aerospace University (BSMRAAU), Dhaka, Bangladesh. He earned his Ph.D. in Engineering in 2017 and his M.Sc. in Computer and Information Engineering in 2013, both from the International Islamic University Malaysia (IIUM). He completed his B.Sc. in Computer Science and Engineering from Chittagong University of Engineering and Technology (CUET), Bangladesh, in 2006. Dr. Bari's research interests include Satellite Communication and Remote Sensing, Computer Vision and Image Processing, Wireless Communication and Network Protocols (TCP/IP), and Sensor Networks.efore joining BSMRAAU in December 2021, he served as an Assistant Professor in the Department of Computer Science and Engineering at the Bangladesh Army University of Science and Technology (BAUST) and the Bangladesh Army International University of Science and Technology (BAIUST). His notable publications include research on convolutional neural network-based object detection models for Bangladeshi traffic vehicles and link budget analysis for military X-band satellite communication."}
