...
return (
    <div className="relative w-full py-48 overflow-hidden">
        ...
        <div className="absolute top-0 left-0 w-full md:w-[55%] h-full bg-zinc-800 z-10 clip-path-backslash">
            ...
            <h1 className="text-3xl md:text-5xl font-bold text-white mb-4 z-10">Join Our Research Community</h1>
            <p className="text-white text-lg md:text-xl max-w-xl z-10">
