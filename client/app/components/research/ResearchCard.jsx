...
export default function HomeCard({ title, description, imageUrl, link }) {
  return (
    <div className="bg-white text-zinc-800 rounded-3xl border-2 border-black shadow-2xl flex flex-col items-left justify-start h-[560px] w-11/12 mx-auto pb-10 mt-20 sm:mx-8 md:mx-auto">
      ...
      (link) 
        ...
        (<p className="text-base line-clamp-4 text-neutral-500 sm:text-base md:text-lg px-4 sm:px-8 md:px-18 mb-4 leading-relaxed text-left">{description}</p>)
          : 
        (<p className="text-base line-clamp-5 text-neutral-500 sm:text-base md:text-lg px-4 sm:px-8 md:px-18 mb-4 leading-relaxed text-left">{description}</p>)
      }
      {link && (
