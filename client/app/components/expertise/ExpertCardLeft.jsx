...
export default function ExpertCardLeft({ name, position, imageSrc, imageAlt, description, facebook, linkedin, whatsapp }) {
    return (
    <div className="flex flex-row justify-center items-center bg-white shadow-2xl mx-auto sm:mx-8 md:mx-auto mt-20 p-8 pb-10 rounded-3xl max-w-6xl h-full text-center text-zinc-800">
